...
public class WordLavel1Result extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_word_lavel1_result);

        databaseReference =FirebaseDatabase.getInstance().getReference().child("Users")
                .child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("WordResult").child("label1");
        ...
        priviousPage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(WordLavel1Result.this,LebelBordActivity.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Word,WordViewHolde>firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Word, WordViewHolde>
                (Word.class,R.layout.showdatalist,WordViewHolde.class,databaseReference) {
            @Override
            protected void populateViewHolder(WordViewHolde viewHolder, Word model, int position) {
...
/*
    ...
    public static class WordViewHolde extends RecyclerView.ViewHolder
    {
        ...
        public void setPridctionres(String prediction) {
            TextView post_incorrect=(TextView)mView.findViewById(R.id.setPridction);
            post_incorrect.setText(prediction);
        }
    }
}
